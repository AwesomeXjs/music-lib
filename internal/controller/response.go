...
func (e *Controller) ResponseHelper(ctx echo.Context, statusCode int, message, detail, request string, myLogger logger.Logger) error {
	myLogger.Response(logger.RESPONSE_PREFIX, strconv.Itoa(statusCode), message)
